...
This project addresses the concept of inheritance in Python programming as part of the object oriented programming.
It contains functions and demonstrations on how the concepts can he used in programming to create worthwhile projects.
The repository contains several files that include: 

0-lookup.py - a function that returns the list of available attributes and methods of an object.
1-my_list.py, tests/1-my_list.txt - a class Mylist that inherits from list
2-is_same_class.py - the function that returnsd true if the obkect is exactly an instance of the specified class; otherwise
false
3-is_kind_of_class.py - a function that returns True if the object is an instance of, or if the object is an instance of a 
class that inherited from, the specified class ; otherwise False.
4-inherits_from.py - a function that returns True if the object is an instance of a class that inherited (directly or indirectly)
