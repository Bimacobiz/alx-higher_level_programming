...
class Rectangle:
    ...
    @property
    def width(self):
        """Get or change the rectangle's width."""
        return self.__width
    ...
    @property
    def height(self):
        """Get or change the rectangle's height."""
    ...
    def square(cls, size=0):
        """Return a new Rectangle with size's width and height.
    ...
    def __str__(self):
        """Return the Rectangle's printed representation.
