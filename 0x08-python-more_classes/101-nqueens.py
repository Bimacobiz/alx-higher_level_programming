...
finds all feasible checkerboard configurations
for N N non-attacking queens.

Example:
    $ ./101-nqueens.py N

N has to be an integer that is at least as large as 4.

Attributes:
    board (list): A list of lists represents the chessboard.
...
def board_deepcopy(board):
    """Send a chessboard deepcopy back."""
